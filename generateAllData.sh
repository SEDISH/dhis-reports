...
mysql -u $USER -p$1 -D $DB -e "source ./report_scripts/patientWithCompleteTbTreatment_event.sql";
mysql -u $USER -p$1 -D $DB -e "source ./report_scripts/patientWithCompleteTbTreatment_tracked_entity.sql";
